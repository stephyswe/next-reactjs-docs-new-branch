function SvgBtnOctiConOne() {
  return (
    <svg
      ...
      className="octicon octicon-chevron-down Details-content--hidden">
      <path
        fillRule="evenodd"
...
function SvgBtnCollapse() {
  return (
    <svg
      aria-label="Collapse added diff lines"
      aria-hidden="false"
      role="img"
      height="16"
      viewBox="0 0 16 16"
